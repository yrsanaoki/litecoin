...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Poohcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zap-hosting", "vps-zap836081-1.zap-srv.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Poohcoin is probably already running."), addrBind.ToString().c_str());
        else
